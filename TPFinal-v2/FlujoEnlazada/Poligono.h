...
struct Poligono {
    Punto puntos; //Pasa a ser una lista enlazada de puntos
    Color c;
};
...
void RemoveUltimoVertice (Poligono &); //Quita el punto en la ultima posición del polígono ingresado como argumento
